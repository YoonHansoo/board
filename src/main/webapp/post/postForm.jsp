	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			 ...
			 <form id="frm" action="${pageContext.request.contextPath}/postForm" method="post" class="form-horizontal" role="form"
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-11">
                     <textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:776px; height:412px;"></textarea> 
                  </div>
               </div>
