				...
				<div class="table-responsive">
					<table class="table table-striped">
						...
						<c:forEach items="${postList}" var="postVo">
								<tr class='postTr' data-postno="${postVo.postNo}" data-postgn="${postVo.post_Gn}" data-flag="${postVo.post_Del_Flag}">
						<td>${postVo.postNo}</td>
						<c:choose>
							<c:when test="${postVo.level gt 1}"> <!--레벨에 따른 공백주기  -->
							<td>
					...
					<input type = "hidden" name="boardNo" value="${boardNm}"> 
