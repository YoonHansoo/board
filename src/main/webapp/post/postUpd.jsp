	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			 ...
			 <form id="frm" action="${pageContext.request.contextPath}/postUpd" method="post" class="form-horizontal" role="form"
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-7">
                        <input type="text" class="form-control" id="userId" name="userId" value="${userVo.userId}" readonly="readonly">
                         ...
                         <input type="hidden" class="form-control" id="boardNm" name="boardNm" value="${boardNm}">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-11">
                     <textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:776px; height:412px;">${postVo.postContent}</textarea> 
                  </div>
               </div>
			
			<div class="form-group">
                  <div class="col-sm-offset-1 col-sm-11">
                  <c:forEach items="${uploadList}" var="uploadfile">
                  <li>
				     <label>${uploadfile.uploadFileName}</label>      
                 	 <button type="button" class="btn btn-default" name="uploadFile">X</button>
                 	   <input type="hidden" class="form-control"  name="uploadFileName" value="${uploadfile.uploadFileName}">
                 	     <input type="hidden" class="form-control"  name="uploadRealFilePath" value="${uploadfile.uploadRealFilePath}">
                  </li>
                  </c:forEach>
                  </div>
               </div>
 			...
 			<div class="form-group">
               ...
               <div class="form-group">
                  <div class="col-sm-offset-1 col-sm-11">
                 	 <button type="button" id="savebutton" class="btn btn-default">수정하기</button>
                  </div>
               </div>
            </form>
			</div>
